...
const Projects = () => {
  return (
    <>
      ...
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://mystivibes.vercel.app/">
      ...
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://ranjandevelop.github.io/weather-app/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://ranjandevelop.github.io/Rock-Paper-Scissors/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://teachiefacademy.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>teachiefacademy.com</p>
          </div>
        </a>
      </div>
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://teachiefaccountingservices.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>TeachiefAccountingServices</p>
          </div>
        </a>
      </div>
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://perfectassignmentcreator.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>PerfectAssignmentCreator</p>
          </div>
        </a>
      </div>
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://highgradeassignmenthelp.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>HighgradeAssignmentHelp</p>
          </div>
        </a>
      </div>
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://perfecttripcreator.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>PerfectTripCreator</p>
          </div>
        </a>
      </div>
      <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://perfectpropertypioneer.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <p>PerfectPropertyPioneer</p>
          </div>
        </a>
      </div>
      {/* <div className="relative group inline-block p-4 w-[100%]">
        <a href="https://www.teachieftechnologies.com/">
          <div className="bg-white py-2 rounded-md shadow-lg hover:cursor-pointer flex justify-center items-center gap-4 px-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
